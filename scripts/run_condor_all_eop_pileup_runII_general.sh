...
if [ $# -eq 0 ]
  ...
  then
    ...
    echo "--> Jobs submitted!"
    echo "source $ROOTCOREBIN/../EoverPAnalysis/scripts/merge_condor_eop.sh $ROOTCOREBIN/../results/run_condor_eop_pileup_runII_general.log # when condor jobs are finished to merge output files"
