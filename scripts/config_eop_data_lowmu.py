...
c.setalg("BasicEventSelection", {"m_name": "BasicEventSelection",
                                 "m_applyGRLCut": True,
                                 "m_GRLxml": "$ROOTCOREBIN/data/data15_13TeV.periodAllYear_DetStatus-v75-repro20-01_DQDefects-00-02-02_PHYS_StandardModel_MinimuBias2010_tolerable_L1CALmisconfigSatBCID.xml",
...
''' E/p histograms with LoosePrimary track selection'''
c.setalg("EoverPAnalysis", {"m_name": "EoverP_LoosePrimaryTrks_EMcalib_Tile_1GeVLar_noTileEfrac",
                            "m_inTrackContainerName": trks_loose,
                            "m_trkExtrapol": "EMB2",
                            "m_energyCalib": "ClusterEnergy", # ClusterEnergy, ClusterEnergyLCW, or CellEnergy
                            "m_doCaloTotal": True,
...
''' E/p histograms with LoosePrimary track selection'''
c.setalg("EoverPAnalysis", {"m_name": "EoverP_LoosePrimaryTrks_EMcalib_Tile_defaultCuts",
                            "m_inTrackContainerName": trks_loose,
                            "m_trkExtrapol": "EMB2",
                            "m_energyCalib": "ClusterEnergy", # ClusterEnergy, ClusterEnergyLCW, or CellEnergy
                            "m_doCaloTotal": True,
...
''' E/p histograms with LoosePrimary track selection'''
c.setalg("EoverPAnalysis", {"m_name": "EoverP_LoosePrimaryTrks_LCWcalib_Tile_defaultCuts",
                            "m_inTrackContainerName": trks_loose,
                            "m_trkExtrapol": "EMB2",
                            "m_energyCalib": "ClusterEnergyLCW", # ClusterEnergy, ClusterEnergyLCW, or CellEnergy
                            "m_doCaloTotal": True,
                            "m_doCaloEM": True,
                            "m_doCaloHAD": True,
                            "m_doBgSubtr" : False,
...
''' E/p histograms with LoosePrimary track selection'''
c.setalg("EoverPAnalysis", {"m_name": "EoverP_LoosePrimaryTrks_CellEnergy_Tile_defaultCuts",
                            "m_inTrackContainerName": trks_loose,
                            "m_trkExtrapol": "EMB2",
                            "m_energyCalib": "CellEnergy", # ClusterEnergy, ClusterEnergyLCW, or CellEnergy
                            "m_doCaloTotal": True,
                            "m_doCaloEM": True,
                            "m_doCaloHAD": True,
                            "m_doBgSubtr" : False,
