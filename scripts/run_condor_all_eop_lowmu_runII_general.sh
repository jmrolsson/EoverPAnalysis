...
if [ $# -eq 0 ]
  ...
  then
    ...
    echo "---> Running MC:"
    echo xAH_run.py --files ${files_mc_ND} --inputList --config EoverPAnalysis/scripts/config_eop_mc_ND_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_ND_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
    echo xAH_run.py --files ${files_mc_SD} --inputList --config EoverPAnalysis/scripts/config_eop_mc_SD_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_SD_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
    echo xAH_run.py --files ${files_mc_DD} --inputList --config EoverPAnalysis/scripts/config_eop_mc_DD_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_DD_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
    xAH_run.py --files ${files_mc_ND} --inputList --config EoverPAnalysis/scripts/config_eop_mc_ND_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_ND_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
    xAH_run.py --files ${files_mc_SD} --inputList --config EoverPAnalysis/scripts/config_eop_mc_SD_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_SD_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
    xAH_run.py --files ${files_mc_DD} --inputList --config EoverPAnalysis/scripts/config_eop_mc_DD_lowmu_runII_general.py --submitDir results/condor_all_eop_lowmu_runII_general_mc_DD_${today}_${tag} --verbose --force condor --optFilesPerWorker 10
