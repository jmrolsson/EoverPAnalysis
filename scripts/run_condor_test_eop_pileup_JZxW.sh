...
if [ $# -eq 0 ]
  ...
  then
    ...
    echo xAH_run.py --files ${files_JZ0W} --inputList --config EoverP/scripts/config_eop_mc.py --submitDir results/condor_test_eop_pileup_JZ0W_${today}_${tag} --verbose --force condor --optFilesPerWorker 2
    xAH_run.py --files ${files_JZ0W} --inputList --config EoverP/scripts/config_eop_mc.py --submitDir results/condor_test_eop_pileup_JZ0W_${today}_${tag} --verbose --force condor --optFilesPerWorker 2
    echo xAH_run.py --files ${files_JZ1W} --inputList --config EoverP/scripts/config_eop_mc.py --submitDir results/condor_test_eop_pileup_JZ1W_${today}_${tag} --verbose --force condor --optFilesPerWorker 2
    xAH_run.py --files ${files_JZ1W} --inputList --config EoverP/scripts/config_eop_mc.py --submitDir results/condor_test_eop_pileup_JZ1W_${today}_${tag} --verbose --force condor --optFilesPerWorker 2
