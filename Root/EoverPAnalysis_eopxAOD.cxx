...
EL::StatusCode EoverPAnalysis_eopxAOD :: histInitialize ()
{
  ...
  m_plots_eop = new EoverPHists_eopxAOD(m_name, m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, m_doTrkPcut, m_trkPmin, m_trkPmax, m_doTrkEtacut, m_trkEtamin, m_trkEtamax);
  if (m_doEtaPranges) {
    m_plots_eop_etaL06 = new EoverPHists_eopxAOD(m_name+"_etaL06", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, false, 0.0, 1e8, true, 0.0, 0.6);
    m_plots_eop_etaG06L11 = new EoverPHists_eopxAOD(m_name+"_etaG06L11", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, false, 0.0, 1e8, true, 0.6, 1.1);
    m_plots_eop_etaG18L19 = new EoverPHists_eopxAOD(m_name+"_etaG18L19", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, false, 0.0, 1e8, true, 1.8, 1.9);
    m_plots_eop_etaG19L23 = new EoverPHists_eopxAOD(m_name+"_etaG19L23", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, false, 0.0, 1e8, true, 1.9, 2.3);
    m_plots_eop_pG1200L1800 = new EoverPHists_eopxAOD(m_name+"_pG1200L1800", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 1.2, 1.8, false, 0.0, 1e8);
    m_plots_eop_pG1800L2200 = new EoverPHists_eopxAOD(m_name+"_pG1800L2200", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 1.8, 2.2, false, 0.0, 1e8);
    m_plots_eop_pG2200L2800 = new EoverPHists_eopxAOD(m_name+"_pG2200L2800", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.2, 2.8, false, 0.0, 1e8);
    m_plots_eop_pG2800L3600 = new EoverPHists_eopxAOD(m_name+"_pG2800L3600", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.8, 3.6, false, 0.0, 1e8);
    m_plots_eop_pG2000 = new EoverPHists_eopxAOD(m_name+"_pG2000", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.0, 1e8, false, 0.0, 1e8);
    m_plots_eop_etaL06_pG2000 = new EoverPHists_eopxAOD(m_name+"_etaL06_pG2000", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, m_LarEmax, m_TileEfrac, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.0, 1e8, true, 0.0, 0.6);
  }
  if (m_doTileCuts) {
    m_plots_eop_etaL20_pG2000_LarL1000 = new EoverPHists_eopxAOD(m_name+"_etaL20_pG2000_LarL1000", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, 1.0, -1, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.0, 1e8, true, 0.0, 2.0);
    m_plots_eop_etaL20_pG2000_LarL1000_TileEfracG075 = new EoverPHists_eopxAOD(m_name+"_etaL20_pG2000_LarL1000_TileEfrac075", m_detailStr, m_trkExtrapol, m_doBgSubtr, m_doEMcalib, m_doLCWcalib, m_doCells, m_doCaloEM, m_doCaloHAD, m_doCaloTotal, m_trkIsoDRmax, m_trkIsoPfrac, 1.0, 0.75, m_Ebins, m_doEbinsArray, m_EbinsArray, m_EtaAbsbins, m_doEtaAbsbinsArray, m_EtaAbsbinsArray, true, 2.0, 1e8, true, 0.0, 2.0);
  }
